...
public class ManageController : ApiController
{
    ...
    {
        var response = await Sender.Send(new GetCurrentUserForEditQuery());
    ...
    {
        var response = await Sender.Send(new GetUserAvatarForEditQuery());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new Disable2FaCommand());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new LoadSharedKeyAndQrCodeUriQuery());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new ResetAuthenticatorCommand());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new DownloadPersonalDataQuery());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new CheckUser2FaStateQuery());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new GenerateRecoveryCodesQuery());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new Get2FaStateQuery());
        return TryGetResult(response);
    }
    ...
    {
        var response = await Sender.Send(new RequirePasswordQuery());
        return TryGetResult(response);
    }
