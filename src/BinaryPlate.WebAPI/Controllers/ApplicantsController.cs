...
public class ApplicantsController : ApiController
{
    ...
    [ProducesResponseType(typeof(ApiSuccessResponse<GetApplicantForEditResponse>), StatusCodes.Status200OK)]
    ...
    [ProducesResponseType(typeof(ApiSuccessResponse<GetApplicantReferencesResponse>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiErrorResponse), StatusCodes.Status500InternalServerError)]
    ...
    [ProducesResponseType(typeof(ApiSuccessResponse<GetApplicantsResponse>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiErrorResponse), StatusCodes.Status500InternalServerError)]
