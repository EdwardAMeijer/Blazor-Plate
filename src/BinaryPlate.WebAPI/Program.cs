...
using BinaryPlate.Application.Common.Models.ApplicationOptions;
...
{
    options.AddPolicy("CorsPolicy", policyBuilder => policyBuilder.AllowAnyHeader()
                                                                  .AllowAnyMethod()
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        // Seed the database.
        await ApplicationDbContextSeeder.SeedAsync(identitySeeder);
    }
    catch (Exception ex)
    {
