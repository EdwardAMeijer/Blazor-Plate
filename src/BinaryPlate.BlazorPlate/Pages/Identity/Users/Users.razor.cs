...
public partial class Users
{
    ...
    private GetUsersResponse GetUsersResponse { get; set; }
    ...
    private async Task<TableData<UserItem>> ServerReload(TableState state)
    {
        ...
        {
            GetUsersResponse = responseWrapper.Payload;
            tableData = new TableData<UserItem> { TotalItems = GetUsersResponse.Users.TotalRows, Items = GetUsersResponse.Users.Items };
        }
        else
        {
