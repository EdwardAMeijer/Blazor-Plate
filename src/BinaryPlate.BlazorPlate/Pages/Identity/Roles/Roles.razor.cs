namespace BinaryPlate.BlazorPlate.Pages.Identity.Roles;
...
public partial class Roles
{
    ...
    private GetRolesResponse GetRolesResponse { get; set; }
    ...
    private async Task<TableData<RoleItem>> ServerReload(TableState state)
    {
        ...
        {
            GetRolesResponse = responseWrapper.Payload;
            tableData = new TableData<RoleItem> { TotalItems = GetRolesResponse.Roles.TotalRows, Items = GetRolesResponse.Roles.Items };
        }
        else
        {
