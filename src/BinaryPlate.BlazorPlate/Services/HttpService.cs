...
public class HttpService(IHttpClientFactory httpClientFactory) : IHttpService
{
    ...
    public async Task<ApiResponseWrapper<TResponse>> Get<TResponse>(string url, string defaultClient = HttpClientType.DefaultClient)
    {
    ...
    public async Task<ApiResponseWrapper<TResponse>> Get<TRequest, TResponse>(string url, TRequest data, string defaultClient = HttpClientType.DefaultClient)
    {
    ...
    public async Task<ApiResponseWrapper<TResponse>> Post<TRequest, TResponse>(string url, TRequest data, string defaultClient = HttpClientType.DefaultClient)
    {
        using var httpClient = httpClientFactory.CreateClient(defaultClient);
    ...
    public async Task<ApiResponseWrapper<TResponse>> Post<TResponse>(string url, string defaultClient = HttpClientType.DefaultClient)
    {
        using var httpClient = httpClientFactory.CreateClient(defaultClient);
    ...
    public async Task<ApiResponseWrapper<TResponse>> PostFormData<TRequest, TResponse>(string url, MultipartFormDataContent data, string defaultClient = HttpClientType.DefaultClient, CancellationToken cancellationToken = default)
    {
        using var httpClient = httpClientFactory.CreateClient(defaultClient);
    ...
    public async Task<ApiResponseWrapper<TResponse>> Put<TRequest, TResponse>(string url, TRequest data, string defaultClient = HttpClientType.DefaultClient)
    {
        using var httpClient = httpClientFactory.CreateClient(defaultClient);
    ...
    public async Task<ApiResponseWrapper<TResponse>> PutFormData<TRequest, TResponse>(string url, MultipartFormDataContent data, string defaultClient = HttpClientType.DefaultClient, CancellationToken cancellationToken = default)
    {
        using var httpClient = httpClientFactory.CreateClient(defaultClient);
    ...
    public async Task<ApiResponseWrapper<TResponse>> Delete<TResponse>(string url, string defaultClient = HttpClientType.DefaultClient)
    {
        using var httpClient = httpClientFactory.CreateClient(defaultClient);
