...
public interface IApplicantsClient
{
    ...
    /// </param>
    /// <returns>A <see cref="GetApplicantReferencesResponse"/>.</returns>

    Task<ApiResponseWrapper<GetApplicantReferencesResponse>> GetApplicantReferences(GetApplicantReferencesQuery getApplicantReferencesQuery);

    /// <summary>
    /// Get a list of applicants.
    /// </summary>
    /// <param name="request">The query parameters for getting the applicants.</param>
    /// <returns>A <see cref="GetApplicantsResponse"/>.</returns>

    Task<ApiResponseWrapper<GetApplicantsResponse>> GetApplicants(GetApplicantsQuery request);
