...
public interface IUsersClient
{
    ...
    /// </summary>
    /// <param name="request">The query parameters.</param>
    /// <returns>A <see cref="GetUsersResponse"/>.</returns>
    Task<ApiResponseWrapper<GetUsersResponse>> GetUsers(GetUsersQuery request);
    ...
    /// </summary>
    /// <param name="request">The query parameters.</param>
    /// <returns>A <see cref="GetUserPermissionsResponse"/>.</returns>
    Task<ApiResponseWrapper<GetUserPermissionsResponse>> GetUserPermissions(GetUserPermissionsQuery request);
