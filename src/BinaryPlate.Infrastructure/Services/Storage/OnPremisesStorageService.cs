...
public class OnPremisesStorageService(IWebHostEnvironment env, IUtcDateTimeProvider utcDateTimeProvider, IHttpContextAccessor httpContextAccessor) : IFileStorageService
{
                                               ...
                                               CancellationToken cancellationToken = default)
    {
        ...
        if (formFile is { Length: > 0 })
            try
            {
                ...
                var directory = Path.Combine(env.WebRootPath, directoryPath);
